        ...
        <div class="lg:w-5/6 w-full mx-auto my-5 font-semibold text-green-400 ">
            <div class="lg:flex items-center justify-between  bg-gray-900 bg-opacity-70 px-3 py-3">
                <div class="flex justify-between  mb-4">
                    <p class="mb-1 font-semibold lg:text-3xl text-xl text-gray-200 w-1/3">PROCESORI</p>
            ...
            <div class="mb-4 hidden lg:block" >
                <div class="flex justify-left pl-3 text-lg items-center font-semibold text-gray-200  bg-green-600 py-2 rounded-t-sm  select-none bg-opacity-70 space-x-2">
                    ...
                    <div class="cursor-pointer border-b-2 border-transparent hover:border-gray-800 hover:text-gray-800 w-1/12 flex items-center" wire:click="sortBy('base_clock')">
                        @include('partials._sort-icon',['field'=>'base_clock'])
                        <p>RADNI TAKT</p>
                    </div>
                    <div class="cursor-pointer border-b-2 border-transparent hover:border-gray-800 hover:text-gray-800 w-1/12 flex items-center" wire:click="sortBy('core_count')">
                        @include('partials._sort-icon',['field'=>'core_count'])
                        <p>VRSTA MEMORIJE</p>
                    </div>
                    <p class="w-2/12" "></p>
                ...
                @foreach ($cpus as $cpu)
                    <div class="flex items-center pl-3 bg-gray-900 bg-opacity-70 border border-green-400 text-lg ">
                        ...
                        <div class="w-1/12 flex justify-center">
                            ...
                            <form action="{{ route('build.cpu.add', []) }}" method="POST">
                                @csrf
                ...
                @foreach ($cpus as $cpu)
                    <div class=" items-center pl-3 bg-gray-900 bg-opacity-70 border border-green-400  ">
                        <div class="flex items-center space-x-3">
                            ...
                            <a href="{{ route('build.cpu.add', ['id'=>$cpu->id]) }}">
                                <input type="hidden" name="id" value="{{ $cpu->id }}">
