                ...
                <div class="flex justify-between items-center">
                    <div class="lg:mr-6 ml-6 lg:text-lg text-md">
                       <label class=""> Po stranici: &nbsp; </label> 
                        <select wire:model="perPage" class="bg-gray-800 rounded-sm  border border-green-400 text-white py-1">
                            <option>10</option>
                            <option>20</option>
                            <option>40</option>
                            <option>100</option>
                ...
                @foreach ($coolers as $cooler)
                    <div class="flex items-center pl-3 bg-gray-900 bg-opacity-70 border border-green-400 text-lg ">
                        ...
                        <div class="w-1/12 flex justify-center">
                            <a href="">
                                <button
                                    class="inline-block px-6 py-2 text-sm font-semibold leading-6 text-center text-gray-700 uppercase transition bg-white rounded shadow ripple hover:shadow-lg hover:bg-gray-400 focus:outline-none my-2 self-center hover:text-white">
                                    DETALJI
                                </button>
                            </a>
                        </div>
