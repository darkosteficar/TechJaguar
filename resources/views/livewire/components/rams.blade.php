        ...
        <div class="lg:w-5/6 w-full mx-auto my-5 font-semibold text-green-400 ">
            <div class="lg:flex items-center justify-between  bg-gray-900 bg-opacity-70 px-3 py-3">
                <div class="flex justify-between  mb-4">
                    <p class="mb-1 font-semibold lg:text-3xl text-xl text-gray-200 w-1/3">RADNE MEMORIJE</p>
                    <div x-data="{show: false}" class="w-2/3 ">
                        ...
                        <div x-show.transition.origin.top.left="show"  class=" justify-left pl-3  items-center  text-gray-200  bg-green-600 py-2 rounded-t-sm  select-none bg-opacity-70 space-y-2 flex-col mb-2">
                            ...
                            <div class="flex pr-2 space-x-2">
                                ...
                                <div class="cursor-pointer border-b-2 border-transparent hover:border-gray-800 hover:text-gray-800 w-full flex items-center" wire:click="sortBy('size')">
                                    @include('partials._sort-icon',['field'=>'size'])
                                    <p>KAPACITET</p>
                                </div>
                            </div>
                            <div class="cursor-pointer border-b-2 border-transparent hover:border-gray-800 hover:text-gray-800 w-1/2 flex items-center" wire:click="sortBy('speed')">
                                @include('partials._sort-icon',['field'=>'speed'])
                                <p>BRZINA</p>
                            </div>
            ...
            <div class="mb-4 hidden lg:block" >
                <div class="flex justify-left pl-3 text-lg items-center font-semibold text-gray-200  bg-green-600 py-2 rounded-t-sm  select-none bg-opacity-70 space-x-2">
                    ...
                    <div class="cursor-pointer border-b-2 border-transparent hover:border-gray-800 hover:text-gray-800 w-1/12 flex items-center" wire:click="sortBy('size')">
                        @include('partials._sort-icon',['field'=>'size'])
                        <p>KAPACITET</p>
                    </div>
                    <div class="cursor-pointer border-b-2 border-transparent hover:border-gray-800 hover:text-gray-800 w-1/12 flex items-center" wire:click="sortBy('speed')">
                        @include('partials._sort-icon',['field'=>'speed'])
                        <p>BRZINA</p>
                    </div>
                    <p class="w-2/12" "></p>
                    ...
                    <div class="flex items-center pl-3 bg-gray-900 bg-opacity-70 border border-green-400 text-lg ">
                        ...
                        <div class="w-1/12">
                            <div class="flex items-center py-2 ">
                                <img src="../images/{{ $ram->images()->first()->path }}" alt="" width="60" class="border-green-500 border">
                            </div>
                        </div>
                        ...
                        <div class="w-1/12 flex justify-center">
                                <button
                                    class="inline-block px-6 py-2 text-sm font-semibold leading-6 text-center text-gray-700 uppercase transition bg-white rounded shadow ripple hover:shadow-lg hover:bg-gray-400 focus:outline-none my-2 self-center hover:text-white" wire:click='$emit("openModal", "modals.rams", @json(["ram" => "$ram->id"]))'">
                                    DETALJI
                                </button>
                        </div>
            ...
            {{ $rams->links('pagination::tailwind-jag') }}
