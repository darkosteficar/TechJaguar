...
<div>
    <div class="bg-gray-600 pt-12 pb-2">
        <p
    class="font-semibold text-4xl text-green-400 pl-10 bg-gray-700 mx-auto py-10 border border-green-400 w-1/2">
    AMD</p>
    <div class="w-5/6 mx-auto ">
    
        <div class=" mb-64 flex items-center  ">
            <div class=" relative w-full">
                <p
                    class="font-semibold text-2xl text-green-400 pl-10 bg-gray-700 w-full py-10 border border-green-400 ">
                    HARDWARE</p>
        ...
        <div class=" mb-80 flex items-center  ">
            <div class=" relative w-full">
                <p
                    class="font-semibold text-2xl text-green-400 pl-10 bg-gray-700 w-full py-10 border border-green-400 ">
                    SOFTWARE</p>
