...
@section('content')
    ...
    <div class="flex mt-10 mx-6">
        ...
        <div class="w-5/6 mx-auto my-5 font-semibold text-green-400 ">
            <p class="mb-1 font-semibold text-3xl text-gray-200">KUĆIŠTA</p>
            ...
            <div class="">
                ...
                @foreach ($pc_cases as $pc_case)
                    <div class="flex items-center pl-3 bg-gray-700 border border-green-400">

                        <div class="w-1/12">
                            <div class="flex items-center py-2 ">
                                <img src="../images/{{ $pc_case->images()->first()->path }}" alt="" width="70" class="border-green-500 border">
                            </div>
                        </div>
                        <div class="flex w-3/12" >
                            <p class="">{{ $pc_case->name }}</p>
                        </div>
                        <div class="flex w-2/12">
                            <p>{{ $pc_case->manufacturer->name }}</p>
                        </div>
                        <div class="w-2/12 ">
                            <p>12 GB GDDR5</p>
                        </div>
                        ...
                        <div class="w-1/12 flex justify-center">
                            ...
                            <form action="{{ route('build.pc_case.add', []) }}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{ $pc_case->id }}">
