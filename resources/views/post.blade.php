...
<div class="lg:w-5/6 w-full mx-auto mt-4 bg-gray-900  pb-12">
    <div class="lg:flex mb-12">
        ...
        <div class="lg:w-10/12 w-full mx-auto pt-4 px-5 text-gray-200">
            ...
            @if (!empty($components['gpu']))
                <!-- Grafička  -->
                <div class="lg:w-2/3 w-full mx-auto mt-6">
                    <table class="bg-gray-600 w-full border-2  border-green-400 mb-6 table-auto">
                        <div class="flex border-green-400 border-2 items-center py-1">
                            <div class="w-8 ml-2 ">
                            ...
                            <p class="w-full bg-gray-900 lg:text-2xl text-lg font-bold text-gray-300 text-center  py-1">
                                {{ $components['gpu']->name }}
                            </p>
                        </div>
                        <tbody class="text-center text-md font-medium text-gray-300 ">
                            <tr class=" hover:bg-gray-800 border border-gray-600 bg-gray-700 ">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">Chipset</td>
                                <td class="">{{ $components['gpu']->chipset->name }}</td>
                                
                            </tr>
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">MSRP</td>
                                <td class="">{{ number_format($components['gpu']->price,2) }} kn</td>
                            ...
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">BUS</td>
                            ...
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">TDP</td>
                ...
                <div class="lg:w-2/3 w-full mx-auto mt-6">
                    <table class="bg-gray-600 w-full border-2  border-green-400 mb-6 table-auto">
                        ...
                        <tbody class="text-center text-md font-medium text-gray-300 ">
                            ...
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">Socket</td>
                                <td class="">{{ $components['cpu']->socket }} </td>
                            </tr>
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">MSRP</td>
                                <td class="">{{ number_format($components['cpu']->price,2)  }} kn</td>
                ...
                <div class="lg:w-2/3 w-full mx-auto mt-6">
                    <table class="bg-gray-600 w-full border-2  border-green-400 mb-6 table-auto">
                        ...
                        <tbody class="text-center text-md font-medium text-gray-300 ">
                            ...
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">Chipset</td>
                                <td class="">{{ $components['mobo']->chipset->name }}</td>
                            </tr>
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">Socket</td>
                                <td class="">{{ $components['mobo']->socket }}</td>
                            ...
                            <tr class="hover:bg-gray-800 bg-gray-700 border border-gray-600">
                                <td class="bg-gray-800 text-gray-300 font-bold py-1">MSRP</td>
                                <td class="">{{ number_format($components['mobo']->price,2)  }} kn</td>
                            </tr>
        ...
        <div class="lg:w-2/12 w-7/12 mx-auto">
