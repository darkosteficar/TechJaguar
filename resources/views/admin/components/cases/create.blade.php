                ...
                <form method="post" action="{{ route('cases.store', []) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <label for="motherboard_form_factor">Supported Fan Count</label>
                                <input class="form-control" type="text" name="fans" data="green" >     
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-3">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <label for="water_cooling">Watercooling Support</label>
